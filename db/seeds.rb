...
# Create groups
group1 = Group.create(name: 'Group 1', icon: 'https://avatars.githubusercontent.com/u/130570844?s=40&v=4',
                      user: john_doe)
group2 = Group.create(name: 'Group 2', icon: 'https://avatars.githubusercontent.com/u/130570844?s=40&v=4',
                      user: jane_doe)
